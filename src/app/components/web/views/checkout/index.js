...
class Checkout extends Component {
    constructor(props) {
        ...
        this.state = {
            isLoaded: false,
            subTotal: '', discount: '', deliveryCharge: 0, grandTotal: '', email: '', customer: '', paymentmethod: '', deliveryAddress: null
        }
    }
    handleRadioChange = e => {
    ...
    handlePlaceOrder = async (event) => {
        ...
        if (deliveryAddress==null) {
            NotificationManager.error("please give delivery address","Address required")
            return
        }
    ...
    handlePaymentSystem = async (e) => {
        ...
        if (!result.data) {
            ...
            var options = {
                "key": __DEV__ ? "rzp_test_fAULtJVrHHhIjX" : "rzp_test_fAULtJVrHHhIjX",
