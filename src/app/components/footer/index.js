                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-3 col-md-3">
                                <h4 className="mb-5 mt-0"><a className="logo" href="index.html"><img src="img/grocLogo.png" alt="prakashop" style={{width:"50px"}} /></a></h4>
                                <p className="mb-0"><a className="text-dark" href="#"><i className="mdi mdi-phone" /> +91 7728960304</a></p>
                                <p className="mb-0"><a className="text-dark" href="#"><i className="mdi mdi-cellphone-iphone" /> +91 7728960304, +91 7728960304</a></p>
                            </div>
                    ...
                    <div className="container">
                        <div className="row no-gutters">
                            <div className="col-lg-6 col-sm-6">
                                <p className="mt-1 mb-0">© Copyright 2023 <strong className="text-dark">PrakashShop</strong>. All Rights Reserved<br />
                                    <small className="mt-0 mb-0">Made with <i className="mdi mdi-heart text-danger" /> by Prakash
                                    </small>
                                </p>
                            </div>
                        </div>
